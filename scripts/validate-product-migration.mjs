...
try {
  ...
  await page.getByRole("link", { name: "Explore Returns" }).click(); await heading("Returns & Compounding"); await layouts("returns-empty");
  ...
  await button("Back to Returns & Compounding").click(); await heading("Returns & Compounding");
  ...
  await button("Mark lesson complete").click(); await heading("Lesson complete"); await button("Back to Returns & Compounding").click(); await heading("Returns & Compounding");
  ...
  assert.match(await page.getByTestId("available-progress").textContent(), /3 of 6 available lessons complete/); await layouts("progress-completed");
  ...
  await page.goto(`${baseURL}/dashboard`); await heading("Continue learning"); await button("Sign out").click(); await heading("Welcome back");
