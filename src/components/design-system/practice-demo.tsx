...
export function PracticeDemo() {
  ...
  return <div className="overflow-hidden rounded-ql-xl border border-ql-border bg-ql-surface shadow-ql-sm">
    ...
    {finished ? <CompletionScreen autoFocusAction title="A little progress, every day." description="You’ve explored how the learning components fit together." xp={20} onContinue={reset} /> : <>
