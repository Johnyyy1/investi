...
export function PracticeCapitalCounter({ value }: { value: bigint }) {
  ...
  return <span aria-live="polite" aria-atomic="true" aria-label={`Virtuální kapitál: ${formatted}`} className="inline-flex min-w-0 flex-col text-ql-small">
    <span className="text-microcopy font-semibold text-secondary">Virtuální kapitál</span>
