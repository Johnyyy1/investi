...
export function LessonFeedback({ state, title, children, onContinue, actionLabel = "Continue", sticky = false, autoFocusAction = false, actionPending = false, actionButtonRef }: {
  state: keyof typeof feedbackStyles; title: string; children: ReactNode; onContinue?: () => void; actionLabel?: string; sticky?: boolean; autoFocusAction?: boolean; actionPending?: boolean; actionButtonRef?: Ref<HTMLButtonElement>;
}) {
