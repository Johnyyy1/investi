...
export function ReturnsOverview({ items, completedLessons }: { items: ModulePathItem[]; completedLessons: number }) {
  ...
  return <>
    <main id="returns-main" className="mx-auto w-full min-w-0 max-w-4xl px-5 pt-8 pb-12 sm:px-10 lg:py-12">
      ...
      <section aria-label="Module progress" className="mt-8 max-w-xl border-y border-ql-border py-6">
        ...
        <p className="mt-4 text-ql-small text-ql-secondary">{completedLessons > 0 ? "Your completed learning is saved to your account." : "Start with one idea. Each completed lesson becomes part of your foundation."} Three lessons are available; the rest are coming soon.</p>
      </section>
