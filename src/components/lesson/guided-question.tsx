...
export function GuidedQuestion({ block, onContinue, pending, continueButtonRef }: { block: QuestionBlock; onContinue: () => void; pending: boolean; continueButtonRef?: Ref<HTMLButtonElement> }) {
