...
export function PreferencesEditor({ initialAnswers }: { initialAnswers: Preferences }) {
  ...
  return <form action={save} className="mt-10 space-y-10">
    ...
    {parsed.success && <section aria-labelledby="updated-path"><h2 id="updated-path" className="mb-4 text-ql-section font-semibold">Your recommended path</h2><PathRecommendation answers={parsed.data} /></section>}
