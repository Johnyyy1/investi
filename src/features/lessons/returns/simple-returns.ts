...
export const simpleReturnsLesson: AuthoredLesson = {
  ...
  blocks: [
    ...
    { id: "period-formula-one", type: "formula", expression: "R_t = (P_t − P_(t−1)) / P_(t−1)", variables: [{ symbol: "R_t", description: "return during period t" }, { symbol: "P_t", description: "current price" }, { symbol: "P_(t−1)", description: "previous period’s price" }] },
    { id: "period-formula-two", type: "formula", expression: "R_t = P_t / P_(t−1) − 1", variables: [{ symbol: "R_t", description: "the same period return" }, { symbol: "P_t", description: "current price" }, { symbol: "P_(t−1)", description: "previous period’s price" }] },
