...
export const whatIsAReturnLesson: AuthoredLesson = {
  ...
  blocks: [
    ...
    { id: "formula-one", type: "formula", latex: "R = \\frac{P_{\\mathrm{end}} - P_{\\mathrm{start}}}{P_{\\mathrm{start}}}", expression: "R = (P_end − P_start) / P_start", variables: [{ symbol: "R", description: "the simple return" }, { symbol: "P_start", description: "the beginning price" }, { symbol: "P_end", description: "the ending price" }] },
    { id: "formula-two", type: "formula", latex: "R = \\frac{P_{\\mathrm{end}}}{P_{\\mathrm{start}}} - 1", expression: "R = P_end / P_start − 1", variables: [{ symbol: "R", description: "the same simple return" }, { symbol: "P_start", description: "the beginning price" }, { symbol: "P_end", description: "the ending price" }] },
